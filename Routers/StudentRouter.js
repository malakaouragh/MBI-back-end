...
router.get(`/dashboard/students`,authController.protect,students.GetAllStudents);
...
router.get(`/purchasedCourses`,authController.protect,students.getUserCourses);
